...
+ [Тип данных char](/StepikC/009/009.md#введение)
	+ [Исследовательские задачи для хакеров](/StepikC/009/009.md#исследовательские-задачи-для-хакеров)
+ [Ввод и вывод символьных строк в Си](/StepikC/009/009.md#ввод-и-вывод-символьных-строк-в-си)
	+ [Создание и инициализация строки](/StepikC/009/009.md#создание-и-инициализация-строки)
	+ [Как вывести строку](/StepikC/009/009.md#как-вывести-строку)
	+ [Ввод строк](/StepikC/009/009.md#ввод-строк)
+ [Функции для работы со строками](/StepikC/009/009.md#функции-для-работы-со-строками)
	+ [Функция strlen](/StepikC/009/009.md#функция-strlen)
	+ [Функция склеивания строк strcat](/StepikC/009/009.md#функция-склеивания-строк-strcat)
	+ [Функция сравнения строк strcmp](/StepikC/009/009.md#функция-сравнения-строк-strcmp)
	+ [Функция копирования строк strcpy](/StepikC/009/009.md#функция-копирования-строк-strcpy)

+ [Задачи](/StepikC/009/009.md#задачи)
	+ [Написать программу для перевод символов в верхний регистр](/StepikC/009/009.md#написать-программу-для-перевод-символов-в-верхний-регистр)
	+ [Вывести соседние символы в таблице ASCII](/StepikC/009/009.md#вывести-соседние-символы-в-таблице-ascii)
	+ [Написать программу для подсчёта различных символов, которые поступают на вход](/StepikC/009/009.md#написать-программу-для-подсчёта-различных-символов-которые-поступают-на-вход)
	+ [Определить тип символа](/StepikC/009/009.md#определить-тип-символа)
	+ [Вывести на экран K символ латинского алфавита в верхнем и нижнем регистре](/StepikC/009/009.md#вывести-на-экран-k-символ-латинского-алфавита-в-верхнем-и-нижнем-регистре)
	+ [Вывести на экран последние K символов латинского алфавита в верхнем регистре в алфавитном порядке](/StepikC/009/009.md#вывести-на-экран-последние-k-символов-латинского-алфавита-в-верхнем-регистре-в-алфавитном-порядке)
	+ [Длина строки](/StepikC/009/009.md#длина-строки)
	+ [Слова](/StepikC/009/009.md#слова)
	+ [Поиск символа](/StepikC/009/009.md#поиск-символа)
	+ [Системы счисления](/StepikC/009/009.md#системы-счисления)
	+ [Лишние пробелы](/StepikC/009/009.md#лишние-пробелы)
	+ [Расстояние Хэмминга](/StepikC/009/009.md#расстояние-хэмминга)
	+ [Остров сокровищ](/StepikC/009/009.md#остров-сокровищ)
	+ [Комментарии](/StepikC/009/009.md#комментарии)
	+ [Форматированный вывод числа](/StepikC/009/009.md#форматированный-вывод-числа)
	+ [Число. Определить является ли данная строка записью числа (целого или вещественного)](/StepikC/009/009.md#число)
	+ [Найти в строке слова, которые начинаются и оканчиваются одной и той же буквой. Слова разделяются пробелами](/StepikC/009/009.md#найти-в-строке-слова-которые-начинаются-и-оканчиваются-одной-и-той-же-буквой-слова-разделяются-пробелами)
	+ [Шифровка](/StepikC/009/009.md#шифровка)
    + [Программа приветствие](/StepikC/009/009.md#программа-приветствие)
    + [Имя файла](/StepikC/009/009.md#имя-файла)
    + [Города](/StepikC/009/009.md#города)
    + [Сравнение строк](/StepikC/009/009.md#сравнение-строк)
    + [Сравнение строк без учёта регистра символов](/StepikC/009/009.md#сравнение-строк-без-учёта-регистра-символов)
    + [Счастливый билетик](/StepikC/009/009.md#счастливый-билетик)
    + [Написать программу, проверяющую, можно ли из букв, входящих в первую строку, составить вторую строку. (буквы можно использовать не более одного раза и можно переставлять)](/StepikC/009/009.md#написать-программу-проверяющую-можно-ли-из-букв-входящих-в-первую-строку-составить-вторую-строку-буквы-можно-использовать-не-более-одного-раза-и-можно-переставлять)
	+ [Азбука Морзе](/StepikC/009/009.md#азбука-морзе)

##  [Функции и указатели](/StepikC/010/010.md)

+ [Справочники стандартных функций Си](/StepikC/010/010.md#справочники-стандартных-функций-си)
+ [Пользовательские функции в Си](/StepikC/010/010.md#пользовательские-функции-в-си)
    + [Как устроены функции](/StepikC/010/010.md#пользовательские-функции-в-си)
    + [Как создать свою функцию](/StepikC/010/010.md#как-создать-свою-функцию)
+ [Область видимости и время жизни переменных](/StepikC/010/010.md#область-видимости-и-время-жизни-переменных)
+ [Указатели в Си](/StepikC/010/010.md#указатели-в-си)
+ [Передача аргументов в функцию](/StepikC/010/010.md#передача-аргументов-в-функцию)
    + [Передача массивов в функцию](/StepikC/010/010.md#передача-массивов-в-функцию)
+ [Задачи](/StepikC/010/010.md#задачи)
    + [Сумматор](/StepikC/010/010.md#сумматор)
    + [Минимум](/StepikC/010/010.md#минимум)
    + [Минимум-2](/StepikC/010/010.md#минимум-2)
    + [Факториал](/StepikC/010/010.md#факториал)
    + [Число сочетаний](/StepikC/010/010.md#число-сочетаний)
    + [Последовательные множители](/StepikC/010/010.md#последовательные-множители)
    + [Квадрат](/StepikC/010/010.md#квадрат)
    + [Форматирование даты](/StepikC/010/010.md#форматирование-даты)
    + [Делители числа](/StepikC/010/010.md#делители-числа)
    + [Переделайте функцию, написанную в прошлом уроке, таким образом, чтобы она возвращала число 1, если число K простое, или 0, если число K не является простым](/StepikC/010/010.md#переделайте-функцию-написанную-в-прошлом-уроке-таким-образом-чтобы-она-возвращала-число-1-если-число-k-простое-или-0-если-число-k-не-является-простым)
    + [В программе имеются две целочисленные переменные a и b. Объявите два указателя с именами p_a и p_b, которые ссылаются на соответствующие переменные](/StepikC/010/010.md#в-программе-имеются-две-целочисленные-переменные-a-и-b-объявите-два-указателя-с-именами-p_a-и-p_b-которые-ссылаются-на-соответствующие-переменные)
    + [В программе имеются символьные переменные ch и inp. Объявите  указатель с именем p_ch, который ссылается на переменную ch, и присвойте ей значение переменной inp](/StepikC/010/010.md#в-программе-имеются-символьные-переменные-ch-и-inp-объявите-указатель-с-именем-p_ch-который-ссылается-на-переменную-ch-и-присвойте-ей-значение-переменной-inp)
    + [В программе объявлены две переменные целого типа. На каждую из них ссылается указатель. На первую ссылается указатель p_1, а на вторую указатель p_2](/StepikC/010/010.md#в-программе-объявлены-две-переменные-целого-типа-на-каждую-из-них-ссылается-указатель-на-первую-ссылается-указатель-p_1-а-на-вторую-указатель-p_2)
    + [Даны два указателя по тем же правилам, что и в предыдущей задаче](/StepikC/010/010.md#даны-два-указателя-по-тем-же-правилам-что-и-в-предыдущей-задаче)
    + [В программе объявлены две переменные целого типа. На каждую из них ссылается указатель. На первую ссылается указатель p_1, а на вторую указатель p_2. Кроме того, объявлена переменная типа double и указатель на неё p_dbl](/StepikC/010/010.md#в-программе-объявлены-две-переменные-целого-типа-на-каждую-из-них-ссылается-указатель-на-первую-ссылается-указатель-p_1-а-на-вторую-указатель-p_2-кроме-того-объявлена-переменная-типа-double-и-указатель-на-неё-p_dbl)
    + [В программе объявлены два указателя p_1 и p_2, которые ссылаются на некоторые переменные. Присвойте переменной на которую ссылается указатель p_1, значение переменной c, а переменной, на которую ссылается указатель p_2, значение переменной d](/StepikC/010/010.md#в-программе-объявлены-два-указателя-p_1-и-p_2-которые-ссылаются-на-некоторые-переменные-присвойте-переменной-на-которую-ссылается-указатель-p_1-значение-переменной-c-а-переменной-на-которую-ссылается-указатель-p_2-значение-переменной-d)
    + [Гилл Байтс написал программу, которая меняет значения двух целочисленных переменных местами. При этом, он поспорил со своим другом Стэном Добсом, что сможет сделать это, используя лишь указатели на данные переменные и дополнительную переменную temp](/StepikC/010/010.md#гилл-байтс-написал-программу-которая-меняет-значения-двух-целочисленных-переменных-местами-при-этом-он-поспорил-со-своим-другом-стэном-добсом-что-сможет-сделать-это-используя-лишь-указатели-на-данные-переменные-и-дополнительную-переменную-temp)
    + [В программе объявлены три целочисленные переменные и указатели на них. Используя лишь указатели, найти среди переменных переменную с минимальным значением. Затем остальным переменным присвоить это значение](/StepikC/010/010.md#в-программе-объявлены-три-целочисленные-переменные-и-указатели-на-них-используя-лишь-указатели-найти-среди-переменных-переменную-с-минимальным-значением-затем-остальным-переменным-присвоить-это-значение)
    + [Написать функцию void swap(int * x, int * y), которая меняет значения переменных местами](/StepikC/010/010.md#написать-функцию-void-swapint--x-int--y-которая-меняет-значения-переменных-местами)
    + [Написать функцию void sum_digits(int * x), которая заменяет число x на сумму цифр из которых состоит число x](/StepikC/010/010.md#написать-функцию-void-sum_digitsint--x-которая-заменяет-число-x-на-сумму-цифр-из-которых-состоит-число-x)
    + [Написать функцию void minmax(int * x, int * y), записывающую в переменную x минимальное из значений x и y, а в переменную y -- максимальное из этих значений](/StepikC/010/010.md#написать-функцию-void-minmaxint--x-int--y-записывающую-в-переменную-x-минимальное-из-значений-x-и-y-а-в-переменную-y----максимальное-из-этих-значений)
    + [Написать функцию void char_register(char * ch, int fl), которая переводит переданный ей символ ch (символ латинского алфавита) в заданный переменной fl регистр: 0 — нижний, 1 — верхний](/StepikC/010/010.md#написать-функцию-void-char_registerchar--ch-int-fl-которая-переводит-переданный-ей-символ-ch-символ-латинского-алфавита-в-заданный-переменной-fl-регистр-0--нижний-1--верхний)
    + [Шифр Цезаря](/StepikC/010/010.md#шифр-цезаря)
    + [Сокращение дроби](/StepikC/010/010.md#сокращение-дроби)
    + [Замена отрицательных элементов массива их модулями](/StepikC/010/010.md#замена-отрицательных-элементов-массива-их-модулями)
    + [Функция минмакс в массиве](/StepikC/010/010.md#функция-минмакс-в-массиве)
    + [Пузырьковая сортировка](/StepikC/010/010.md#пузырьковая-сортировка)
    + [Линейный поиск](/StepikC/010/010.md#линейный-поиск)
    + [Бинарный поиск](/StepikC/010/010.md#бинарный-поиск)

## Добил курс и как мог оформил!

![010](/StepikC/Pictures/010_006.png)

![010](/StepikC/Pictures/010_005.png)
