...
START_TEST(s21_mul_2_simple) {
  s21_decimal dec1 = {{51, 0, 0, NEGATIVE}};
  s21_decimal dec2 = {{22, 0, 0, POSITIVE}};
  s21_decimal res = {0};
  s21_decimal answer = {{1122, 0, 0, NEGATIVE}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_mul_3_simple) {
  ...
  s21_decimal dec2 = {{1057222719, scomp(4030661616), 66076419, NEGATIVE}};
  s21_decimal res = {0};
  s21_decimal answer = {{-1, -1, -1, NEGATIVE}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_mul_9_simple) {
  ...
  s21_decimal dec2 = {{6, 0, 0, scomp(NEGATIVE)}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_mul_10_simple) {
  s21_decimal dec1 = {{500, 0, 0, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{3, 0, 0, scomp(NEGATIVE)}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_mul_11_simple) {
  s21_decimal dec1 = {{2, 0, 0, 0}};
  s21_decimal dec2 = {{5, 0, 0, scomp(NEGATIVE)}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_mul_13_scale) {
  ...
  s21_decimal dec2 = {{169312846, 0, 0, scomp(NEGATIVE + SCALE(6))}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ...
  ck_assert_int_eq(res.bits[2], 0);
  ck_assert_int_eq(res.bits[3], scomp(NEGATIVE + SCALE(12)));
}
END_TEST
...
START_TEST(s21_mul_15_scale) {
  s21_decimal dec1 = {{32, 0, 0, scomp(NEGATIVE + SCALE(1))}};
  s21_decimal dec2 = {{3, 0, 0, scomp(NEGATIVE + SCALE(1))}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_mul_19_error) {
  s21_decimal dec1 = {{0, 0, 1, 0}};
  s21_decimal dec2 = {{0, -1, 0, scomp(NEGATIVE)}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
...
START_TEST(s21_mul_20_error) {
  s21_decimal dec1 = {{0, 0, 1, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{0, -1, 0, scomp(NEGATIVE)}};
  s21_decimal res = {{0, 0, 0, 0}};
  int error = s21_mul(dec1, dec2, &res);
  ck_assert_int_eq(error, 1);
