...
START_TEST(s21_sub_1_simple) {
  s21_decimal dec1 = {{0, 0, INT16_MAX, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{0, 0, INT32_MAX, POSITIVE}};
  s21_decimal res = {0};
  s21_decimal answer = {{0, 0, scomp(2147516414), scomp(NEGATIVE)}};
  int error = s21_sub(dec1, dec2, &res);
...
START_TEST(s21_sub_2_simple) {
  ...
  s21_decimal dec2 = {{0, 0, INT32_MAX, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  s21_decimal answer = {{0, 0, scomp(2147516414), POSITIVE}};
  int error = s21_sub(dec1, dec2, &res);
...
START_TEST(s21_sub_4_simple) {
  ...
  s21_decimal res = {0};
  s21_decimal answer = {{900, 0, 0, scomp(NEGATIVE)}};
  int error = s21_sub(dec1, dec2, &res);
...
START_TEST(s21_sub_5_error) {
  ...
  s21_decimal dec2 = {{1, 0, 0, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  s21_decimal answer = {{0, 0, 0, POSITIVE}};
  int error = s21_sub(dec1, dec2, &res);
...
START_TEST(s21_sub_6_error) {
  s21_decimal dec1 = {{UINT32_MAX, UINT32_MAX, UINT32_MAX, scomp(NEGATIVE)}};
...
START_TEST(s21_sub_9_scale) {
  s21_decimal dec1 = {{0, 0, 13, scomp(NEGATIVE)}};  // -239807672958224171008
  s21_decimal num2 = {
      {135676145, 0, 0, scomp(SCALE(9) + scomp(NEGATIVE))}};  // 0.135676145
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
  ...
  ck_assert_int_eq(res.bits[3], scomp(SCALE(8) + scomp(NEGATIVE)));
}
END_TEST
...
START_TEST(s21_sub_9a_scale) {
  s21_decimal dec1 = {{0, 0, 13, scomp(NEGATIVE)}};  // -239807672958224171008
  s21_decimal num2 = {
      {135676155, 0, 0, scomp(SCALE(9) + scomp(NEGATIVE))}};  // 0.135676155
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_sub_10_error) {
  s21_decimal dec1 = {{-1, -1, -1688, scomp(NEGATIVE)}};  // -1688 = 4294965608
...
START_TEST(s21_sub_12_error) {
  ...
  s21_decimal num2 = {{0, 0, 1688, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 1);
  ck_assert_int_eq(res.bits[0], 0);
...
START_TEST(s21_sub_15_error) {
  s21_decimal dec1 = {{-1, -1, -1688, scomp(NEGATIVE)}};
...
START_TEST(s21_sub_16_simple) {
  s21_decimal dec1 = {{10, 11, 12, scomp(scomp(NEGATIVE))}};
  s21_decimal num2 = {{11, 13, 15, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], 1);
...
START_TEST(s21_sub_17_simple) {
  ...
  s21_decimal num2 = {{44, 369, 1687, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 1);
  ck_assert_int_eq(res.bits[0], 0);
...
START_TEST(s21_sub_18_scale) {
  s21_decimal dec1 = {{45, 0, 10, scomp(scomp(NEGATIVE))}};
  s21_decimal num2 = {{67, 0, 1, scomp(scomp(NEGATIVE) + SCALE(2))}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
  ...
  ck_assert_int_eq(res.bits[3], scomp(scomp(NEGATIVE) + SCALE(2)));
}
END_TEST
...
START_TEST(s21_sub_21_scale) {
  s21_decimal dec1 = {{-3, -1, -1, scomp(scomp(NEGATIVE))}};
  s21_decimal num2 = {
      {7, 0, 0,
       scomp(SCALE(1) + scomp(NEGATIVE))}};  // это SCALE(1) и scomp(NEGATIVE)
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_sub_23_scale) {
  s21_decimal dec1 = {{0, 0, 13, scomp(scomp(NEGATIVE))}};
  s21_decimal num2 = {{4, 0, 0, scomp(scomp(NEGATIVE) + SCALE(9))}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], 0);
  ...
  ck_assert_int_eq(res.bits[3], scomp(scomp(NEGATIVE) + SCALE(8)));
}
END_TEST

START_TEST(s21_sub_24_simple) {
  s21_decimal dec1 = {{6, 7, 8, POSITIVE}};
  s21_decimal num2 = {{5, 4, 3, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_sub_25_simple) {
  ...
  s21_decimal num2 = {{5, 4, 8, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_sub(dec1, num2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_sub_26_simple) {
  s21_decimal dec1 = {{6, 7, 8, scomp(scomp(NEGATIVE))}};
...
START_TEST(s21_sub_27_simple) {
  s21_decimal dec1 = {{3, 1, 3, scomp(scomp(NEGATIVE))}};
