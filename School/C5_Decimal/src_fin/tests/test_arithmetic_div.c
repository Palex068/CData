...
START_TEST(s21_div_1_simple) {
  s21_decimal dec1 = {{0, 6500, 0, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{0, 6500, 0, POSITIVE}};
  s21_decimal res = {0};
  s21_decimal answer = {{1, 0, 0, scomp(NEGATIVE)}};
  int error = s21_div(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_div_2_simple) {
  ...
  s21_decimal dec2 = {{0, 0, UINT32_MAX, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  s21_decimal answer = {{1, 0, 0, scomp(NEGATIVE)}};
  int error = s21_div(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_div_14_simple) {
  ...
  s21_decimal dec2 = {{8, 0, 0, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  s21_decimal answer = {{9, 0, 0, scomp(scomp(NEGATIVE))}};
  int error = s21_div(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_div_15_scale_fraction) {
  s21_decimal dec1 = {{8, 0, 0, scomp(scomp(NEGATIVE))}};
  s21_decimal dec2 = {{72, 0, 0, POSITIVE}};
  s21_decimal res = {0};
  s21_decimal answer = {
      {1461481927, 115845870, 60233454, scomp(scomp(NEGATIVE) + SCALE(28))}};
  int error = s21_div(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_div_23_fraction) {
  s21_decimal dec1 = {{10, 0, 0, POSITIVE}};
  s21_decimal dec2 = {{4, 0, 0, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_div(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ...
  ck_assert_int_eq(res.bits[1], 0);
  ck_assert_int_eq(res.bits[2], 0);
  ck_assert_int_eq(res.bits[3], scomp(SCALE(1) + scomp(NEGATIVE)));
}
END_TEST
...
START_TEST(s21_div_39_overflow) {
  ...
  ck_assert_int_eq(res.bits[1], 0);
  ck_assert_int_eq(res.bits[2], 1073741824);
  ck_assert_int_eq(res.bits[3], scomp(scomp(NEGATIVE) + SCALE(28)));
}
END_TEST

START_TEST(s21_div_40_error) {
  s21_decimal dec1 = {{1, 1, 1, SCALE(28)}};
  s21_decimal dec2 = {{0, 0, 0, scomp(scomp(NEGATIVE))}};
  s21_decimal res = {0};
  s21_decimal answer = {{0, 0, 0, 0}};
  int error = s21_div(dec1, dec2, &res);
  ck_assert_int_eq(error, 3);
