...
START_TEST(s21_add_2_simple) {
  ...
  s21_decimal dec2 = {{0, INT32_MAX, 0, scomp(NEGATIVE)}};
  s21_decimal res = {0};
...
START_TEST(s21_add_3_simple) {
  ...
  s21_decimal dec2 = {{UINT16_MAX, 0, 0, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  s21_decimal answer = {{32768, 0, 0, scomp(NEGATIVE)}};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_add_7_scale) {
  ...
  s21_decimal dec2 = {{9, 0, 0, scomp(NEGATIVE) + SCALE(2)}};
  s21_decimal res = {0};
...
START_TEST(s21_add_8_scale) {
  s21_decimal dec1 = {{-1, -1, -1, POSITIVE + SCALE(0)}};
  s21_decimal dec2 = {{6, 0, 0, scomp(NEGATIVE) + SCALE(1)}};
  s21_decimal res = {0};
  s21_decimal answer = {{-2, -1, -1, POSITIVE + SCALE(0)}};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  for (int i = 0; i <= 3; i++) ck_assert_int_eq(res.bits[i], answer.bits[i]);
}
...
START_TEST(s21_add_9_simple) {
  s21_decimal dec1 = {{-1, -1, 56648, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{44, 369, 1687, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], 43);
...
START_TEST(s21_add_11_scale) {
  ...
  s21_decimal dec2 = {{67, 0, 0, scomp(SCALE(2) + scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ...
  ck_assert_int_eq(res.bits[3], scomp(SCALE(2) + scomp(NEGATIVE)));
}
END_TEST
...
START_TEST(s21_add_14_scale) {
  s21_decimal dec1 = {
      {UINT32_MAX - 2, UINT32_MAX, UINT32_MAX, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{7, 0, 0, scomp(SCALE(1) + scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], -2);
...
START_TEST(s21_add_15_scale) {
  ...
  ck_assert_int_eq(res.bits[3],
                   SCALE(8));  // 184467440737095516160.00000000
}
END_TEST

START_TEST(s21_add_16_scale) {
  s21_decimal dec1 = {{0, 0, 13, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{135676145, 0, 0, scomp(SCALE(9) + scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_add_16a_scale) {
  s21_decimal dec1 = {{0, 0, 13, scomp(NEGATIVE)}};
  s21_decimal dec2 = {{135676165, 0, 0, scomp(SCALE(9) + scomp(NEGATIVE))}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
...
START_TEST(s21_add_17_simple) {
  ...
  s21_decimal dec2 = {{5, 4, 3, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], 1);
...
START_TEST(s21_add_18_simple) {
  ...
  s21_decimal dec2 = {{5, 4, 8, scomp(NEGATIVE)}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], 2);
...
START_TEST(s21_add_22a_scale) {
  s21_decimal dec1 = {{-1, -1, -1, POSITIVE + SCALE(28)}};
  s21_decimal dec2 = {{-1, -1, -1, POSITIVE + SCALE(28)}};
  s21_decimal res = {0};
  int error = s21_add(dec1, dec2, &res);
  ck_assert_int_eq(error, 0);
  ck_assert_int_eq(res.bits[0], scomp(858993459));
  ck_assert_int_eq(res.bits[1], scomp(858993459));
  ck_assert_int_eq(res.bits[2], scomp(858993459));
...
Suite *s21_arithmetic_add_suite() {
  ...
  tcase_add_test(tc, s21_add_22a_scale);
