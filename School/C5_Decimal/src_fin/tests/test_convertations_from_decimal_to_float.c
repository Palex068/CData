...
START_TEST(test_s21_dec_to_float_m18_122f) {
  ...
  result.bits[1] = 0;
  result.bits[2] = 0;
  result.bits[3] = scomp(2147680256);
  int err = s21_from_decimal_to_float(result, &check);
  ck_assert_float_eq(check, -18.122);
  ck_assert_int_eq(err, S21_OK);
}
...
START_TEST(test_s21_dec_to_float_m2345_09) {
  ...
  result.bits[1] = 0;
  result.bits[2] = 0;
  result.bits[3] = scomp(2147745792);
  int err = s21_from_decimal_to_float(result, &check);
...
Suite *s21_convertations_decimal_to_float(void) {
  Suite *s = suite_create("s21_from_decimal_to_float");
  TCase *tc = tcase_create("s21_decimal");
  suite_add_tcase(s, tc);

  tcase_add_test(tc, test_s21_dec_to_float_003f);
  tcase_add_test(tc, test_s21_dec_to_float_18122f);
  tcase_add_test(tc, test_s21_dec_to_float_m003f);
  tcase_add_test(tc, test_s21_dec_to_float_18_122f);
  tcase_add_test(tc, test_s21_dec_to_float_m1812);
  tcase_add_test(tc, test_s21_dec_to_float_16777215f);
  tcase_add_test(tc, test_s21_dec_to_float_12345_6789f);
  tcase_add_test(tc, test_s21_dec_to_float_UNIT_MAX);
  tcase_add_test(tc, test_s21_dec_to_float_m1234_5678f);
  ...
  tcase_add_test(tc, test_s21_dec_to_float_m18_122f);
  tcase_add_test(tc, test_s21_dec_to_float_m1812f);
  tcase_add_test(tc, test_s21_dec_to_float_16777215f);
  tcase_add_test(tc, test_s21_dec_to_float_m2345_09);
  tcase_add_test(tc, test_s21_dec_to_float_UINT_MAX_UINT_MAX);
  tcase_add_test(tc, test_s21_dec_to_float_scale_error);
  tcase_add_test(tc, test_s21_dec_to_float_null_error);
