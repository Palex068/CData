...
Suite *s21_convertations_decimal_to_int(void) {
  ...
  tcase_add_test(tc, test_s21_decimal_to_int_max_scale_1);
  tcase_add_test(tc, test_s21_decimal_to_int_max_scale_10);
  tcase_add_test(tc, test_s21_decimal_to_int_max_scale_28);
  tcase_add_test(tc, test_s21_decimal_to_int_max_scale_29_error);
  ...
  tcase_add_test(tc, test_s21_decimal_to_int_min_plus_1_scale_1);
  tcase_add_test(tc, test_s21_decimal_to_int_min_plus_1_scale_10);
  tcase_add_test(tc, test_s21_decimal_to_int_min_plus_1_scale_28);
  tcase_add_test(tc, test_s21_decimal_to_int_min_plus_1_scale_29_error);
  tcase_add_test(tc, test_s21_decimal_to_int_big_number_error);
  tcase_add_test(tc, test_s21_decimal_to_int_null_error);
