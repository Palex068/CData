/**
 * @file
 * @brief Файл с реализацией структур и функций игрового процесса
 *
 * @note Данный файл содержит в себе реализацию структур и функций игрового
 * процесса
 */
...
void userInput(UserAction_t action, bool hold) {
  ...
  chtype ch = 0;
  switch (action) {
    case Start:  ///< Приглашение к началу игры
