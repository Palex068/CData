...
struct qt_meta_stringdata_CLASSPrinterENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPrinterENDCLASS = QtMocHelpers::stringData(
    "Printer",
    "print",
    "",
    "text"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPrinterENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Printer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPrinterENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPrinterENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPrinterENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Printer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPrinterENDCLASS.stringdata0))
